...
async function main() {
  ...
  // Edge middleware-friendly export (avoids JSON-import attribute compatibility quirks).
  const jsBody =
    '// Auto-generated by scripts/build-slug-index.mjs — do not edit.\n' +
    'export default ' + JSON.stringify(slugs) + ';\n';
  await writeFile(join(ROOT, 'slug-index.js'), jsBody);
  console.log(`[ok] slug-index.json + slug-index.js written: ${slugs.length} apps`);
}
